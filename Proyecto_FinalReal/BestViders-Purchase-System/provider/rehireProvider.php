    ...
    <div class="card-container">
        ...
        <div class="form-card">
            <form action="providerRHProcess.php" method="POST">
                <h2 class="mb-4">Rehire Provider</h2>

                <div class="form-group">
                    <label for="num">Provider Number</label>
                    <input type="number" name="num" id="num" class="form-control" value="<?= htmlspecialchars($infoProvider['num']) ?>" readonly>
                </div>

                <div class="form-group">
                    <label for="fiscalName">Fiscal Name of the Provider</label>
                    <input type="text" name="fiscalName" id="fiscalName" class="form-control" value="<?= htmlspecialchars($infoProvider['fiscalName']) ?>" readonly>
                </div>
